...
function showInfo(item: any) {
  ...
  formState.td_gd = window.mapWork.formatDistance(item.point?.alt)
  formState.td_times = window.mapWork.formatTime(item.second)
  formState.td_alltimes = window.mapWork.formatTime(item.second_all)
  formState.td_length = window.mapWork.formatDistance(item.distance) || "0米"
  formState.td_alllength = window.mapWork.formatDistance(item.distance_all)
}
</script>
