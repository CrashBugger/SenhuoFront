...
<a-space><div></div><div></div></a-space>
  ...
  <mars-dialog :visible="sum" title="火灾信息" width="380" top="30" bottom="50" left="60">
    <template #icon>
  ...
  <mars-dialog :visible="c_show" left="10" bottom="60" width="528">
    <div class="test">
      ...
      <div class="chart_dian">
        <div class="chartOne_dian" id="chartOne_dian">
          <h6>无人机电量变化</h6>
        <div id="ul_HSCD" class="chartOne_dian_ulhscd"></div>
      </div>
    </div>
  </a-form-item>
  </div>
